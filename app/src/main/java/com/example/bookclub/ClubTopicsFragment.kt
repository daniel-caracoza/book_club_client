...
import com.example.bookclub.ui.ClubTopicAdapter
...
class ClubTopicsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding: FragmentClubTopicsBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_club_topics, container, false)
